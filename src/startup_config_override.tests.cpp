...
TEST_CASE("Startup config override accepts canonical absolute drive paths")
{
	...
	CHECK(StartupConfigOverride::IsDefaultIncomingDirectoryFromBaseDir(_T("C:\\profiles\\test-root"), _T("C:\\profiles\\test-root\\Incoming")));
	CHECK(StartupConfigOverride::IsDefaultIncomingDirectoryFromBaseDir(_T("C:\\profiles\\test-root\\"), _T("c:\\profiles\\test-root\\incoming\\")));
	CHECK_FALSE(StartupConfigOverride::IsDefaultIncomingDirectoryFromBaseDir(_T("C:\\profiles\\test-root"), _T("C:\\downloads\\incoming\\")));
