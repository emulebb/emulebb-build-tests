...
| `scripts\check-rust-openapi-routes.py` | Rust REST contract guard | maintained | compares emulebb-rust route, query, and body metadata against the Rust OpenAPI artifact |
