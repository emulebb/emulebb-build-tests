...
from emule_test_harness.preference_schema import build_preference_schema
...
def main() -> int:
    ...
    output_path = workspace_root / "repos" / "emulebb-build-tests" / "manifests" / "preference-schema.v1.json"
